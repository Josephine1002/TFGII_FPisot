...
>>>>>>> d1864b008a65d0b02b80d29df79ea1a96528d606
% Castellano
...
% Entrada para Google Places API
\newglossaryentry{google-places-api}{
	name=Google Places,
	description={Servicio ofrecido por Google que proporciona información detallada sobre lugares, como valoraciones, fotos y descripciones}
}

% Entrada para optimización de rutas
\newglossaryentry{route-optimization}{
	name=Optimización de rutas,
	description={Proceso de calcular la ruta más eficiente que conecta múltiples puntos de interés según criterios como distancia, tiempo y medio de transporte}
}

% Entrada para LangChain
\newglossaryentry{langchain}{
	name=LangChain,
	description={Framework de inteligencia artificial utilizado para construir aplicaciones que combinan múltiples modelos de lenguaje y agentes}
}

% Entrada para BLoC
\newglossaryentry{bloc}{
	name=BLoC (Business Logic Component),
	description={Patrón arquitectónico en Flutter que separa la lógica de negocio de la interfaz de usuario}
} 
